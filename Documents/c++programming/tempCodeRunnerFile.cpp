...
class hotel
{
    ...
    static void getdata();
    // {
    //     cout<<hotel_id<<"\t"<<hotel_name<<"\t"<<hotel_type<<"\t"<<hotel_location<<"\t"<<hotel_rating<<"\t"<<hotel_room_quantity<<"\t"<<hotel_staff_quantity<<"\t"<<hotel_establish_year<<endl;
    // }
...
int main()
{
    ...
    // cout<<"Enter the total number of the hotel :=";
    // cin>>n;
